...
class Article extends React.Component {
	...
	render() {
        ...
        function markTag(tags){
            ...
            return tags.map((tag) => (
                <span key={i++} className="article-more-tag">{tag}</span>
            ))
        }
        function weixinPush(){
		...
		return (
			<section className="content-wrap ">
	        	<div className="container pc-body1">
		        	<div className="row article">
			        	<main className="col-md-8 main-content pc-body1">
						    ...
						    <footer className="post-footer clearfix">
                                <div className="bdsharebuttonbox">
									<div className="pull-right-share modal-weixin-buttom" title="分享" style={{cursor:'pointer'}}>
										<span>分享</span>
									</div>
